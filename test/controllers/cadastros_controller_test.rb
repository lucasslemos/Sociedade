...
class CadastrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cadastro" do
    assert_difference('Cadastro.count') do
      post cadastros_url, params: { cadastro: { cpf: @cadastro.cpf, email: @cadastro.email, nome: @cadastro.nome, telefone: @cadastro.telefone } }
    end
  ...
  test "should update cadastro" do
    patch cadastro_url(@cadastro), params: { cadastro: { cpf: @cadastro.cpf, email: @cadastro.email, nome: @cadastro.nome, telefone: @cadastro.telefone } }
